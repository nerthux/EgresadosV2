...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Generation'), ['action' => 'edit', $generation->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Generation'), ['action' => 'delete', $generation->id], ['confirm' => __('Are you sure you want to delete # {0}?', $generation->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Generations'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Generation'), ['action' => 'add']) ?> </li>
